...
namespace ReverseProxyService.Utilities
{
  public class HttpCommunicationClientFactory : CommunicationClientFactoryBase<HttpCommunicationClient>
  {
    ...
    public HttpCommunicationClientFactory(HttpClient httpClient, IServicePartitionResolver resolver = null, IEnumerable<IExceptionHandler> exceptionHandlers = null)
